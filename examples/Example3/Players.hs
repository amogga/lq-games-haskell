...
player1 = let
              ...
              costInfo1 = I.CostInfo1 { I.goal = Position (6.0,35.0),
                                      I.lane = [[6.0,-100.0],[6.0,100.0]], I.laneBoundary = 3,
                                      I.minVelocity = 0, I.maxVelocity = 12, I.nominalVelocity = 8,
                                      I.proximity = 4
                                    }
...
player2 = let
              ...
              costInfo1 = I.CostInfo1 { I.goal = Position (12,12),
                                      I.lane = [[2.0,100.0],[2.0,18.0],[2.5,15.0],[3.0,14.0],[5.0,12.5],[8.0,12.0],[100.0,12.0]], I.laneBoundary = 3,
                                      I.minVelocity = 0, I.maxVelocity = 10, I.nominalVelocity = 5,
                                      I.proximity = 4
                                    }

              -- state and input weights
              stateWeight1 = W.StateWeight1 { W.goal = 1,
                                            W.lane = 50, W.laneBoundary = 50,
...
bicycle = let
              ...
              -- state and input weights
              stateWeight1 = W.StateWeight2 { W.goal = 5,
                                            W.maxVelocity = 100, W.minVelocity = 100, W.nominalVelocity = 0,
                                            W.proximity = 100
                                          }
              inputWeight1 = W.InputWeight2 { W.steeringAngle = 30,
                                            W.acceleration = 20
                                          }
