...
player1 = let stateWeight1 = StateWeight1 { goalW = 1, polylineW = 50, polylineBoundaryW = 50, maxVelocityW = 100, minVelocityW = 100, proximityW = 100
                                    }
              ...
              stateIndex1 = StateIndex1 { positionStateIndices = [0,1], velocityStateIndex = 3 }
...
player2 = let stateWeight1 = StateWeight1 { goalW = 1, polylineW = 50, polylineBoundaryW = 50, maxVelocityW = 100, minVelocityW = 100, proximityW = 100 }
              inputWeight1 = InputWeight1 { angularVelocityW = 25, accelerationW = 1 }       
              ...
              stateIndex1 = StateIndex1 { positionStateIndices = [4,5], velocityStateIndex = 7 }
            in Car { 
                    stateIndex = stateIndex1,
                    inputIndex = inputIndex1,
                    costInfo = costInfo1,
...
bicycle = let stateWeight1 = StateWeight2 { goalW = 1, maxVelocityW = 100, minVelocityW = 100, proximityW = 100 }
              ...
              costInfo1 = CostInfo2 { goalC = Position (15,21), proximityC = 1, maxVelocityC = 2.5, minVelocityC = 1 }
              inputIndex2 = InputIndex2 { steeringAngleInputIndex = 4, accelerationInputIndex = 5 }
              stateIndex2 = StateIndex1 { positionStateIndices = [8,9], velocityStateIndex = 11 }
